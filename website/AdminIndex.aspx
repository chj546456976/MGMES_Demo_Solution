...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <style>
        ...
        .tabs-panels { border-width: 0px; padding: 10px; }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="left">
        ...
        <div class="userarea">
            <h4>
                用户：&nbsp;&nbsp;[&nbsp;<asp:Literal ID="namelit" runat="server"></asp:Literal>&nbsp;]
            </h4>
            <h4>
                职位：&nbsp;&nbsp;[&nbsp;<asp:Literal ID="tellit" runat="server"></asp:Literal>&nbsp;]
            </h4>
        </div>
        <div class="clear">
        </div>
        <div class="menu">
            <div class="easyui-accordion" style="width: 180px;">
                <div title="基础档案" data-options="iconCls:'folder_edit_16px'" style="overflow: hidden;
                    padding: 0px 10px; margin: 0px 0px 0px 0px">
                    <ul class="first">
                        <li>
                            <ul class="second">
                                <li url='../foundation/department.aspx' id="li4" runat="server">
                                    <img src="/image/admin/1.png" /><a>部门档案</a></li>
                                <li url='../foundation/Position.aspx' id="li5" runat="server">
                                    <img src="/image/admin/2.png" /><a>职位档案</a></li>
                                <li url='#' id="li6" runat="server">
                                    <img src="/image/admin/3.png" /><a>用户权限管理</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                <div title="部件档案" data-options="iconCls:'puzzle_15'" style="overflow: hidden; padding: 0px 10px;
                    margin: 0px 0px 0px 0px">
                    <ul class="first">
                        <li>
                            <ul class="second">
                                <li id="li7" runat="server" url='#'>
                                    <img src="/image/admin/1.png" /><a>整套座椅代号</a></li>
                                <li id="li8" runat="server" url='#'>
                                    <img src="/image/admin/2.png" /><a>部分座椅配置</a></li>
                                <li id="li9" runat="server" url='#'>
                                    <img src="/image/admin/3.png" /><a>部件档案</a></li>
                            </ul>
                        </li>
                </div>
                <div title="生产线档案" data-options="iconCls:'computer_17'" style="overflow: hidden;
                    padding: 0px 10px; margin: 0px 0px 0px 0px">
                    <ul class="first">
                        <li>
                            <ul class="second">
                                <li id="li14" runat="server" url='../foundation/FlowLine.aspx'>
                                    <img src="/image/admin/1.png" /><a>流水线档案</a></li>
                                <li id="li15" runat="server" url='#'>
                                    <img src="/image/admin/2.png" /><a>工位档案</a></li>
                                <li id="li16" runat="server" url='../foundation/Step.aspx'>
                                    <img src="/image/admin/3.png" /><a>工序步骤管理</a></li>
                                <li id="li17" runat="server" url='../foundation/Classes.aspx'>
                                    <img src="/image/admin/4.png" /><a>班次档案</a></li>
                            </ul>
                        </li>
                </div>
                <div title="生产订单管理" data-options="iconCls:'list_12'" style="overflow: hidden; padding: 0px 10px;
                    margin: 0px 0px 0px 0px">
                    <ul class="first">
                        <li>
                            <ul class="second">
                                <li id="li1" runat="server" url='#'>
                                    <img src="/image/admin/1.png" /><a>客户订单</a></li>
                                <li id="li10" runat="server" url='#'>
                                    <img src="/image/admin/2.png" /><a>生产通知单</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                <div title="查询统计" data-options="iconCls:'icon-search'" style="overflow: hidden; padding: 0px 10px;
                    margin: 0px 0px 0px 0px">
                    <ul class="first">
                        <li>
                            <ul class="second">
                                <li id="li12" runat="server" url='#'>
                                    <img src="/image/admin/1.png" /><a>工序步骤日志</a></li>
                                <li id="li13" runat="server" url='#'>
                                    <img src="/image/admin/2.png" /><a>客户订单统计</a></li>
                                <li id="li11" runat="server" url='#'>
                                    <img src="/image/admin/3.png" /><a>生产通知单统计</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                <div title="注销" data-options="iconCls:'dialog_shutdown_16px'" style="overflow: hidden;
                    padding: 0px 10px; margin: 0px 0px 0px 0px">
                    <ul class="first">
                        <li>
                            <ul class="second">
    ...
    <script>
        ...
        var iframe = '<iframe src="$$$"  style="width:100%;border:0px;height:100%" scrolling="auto" seamless="seamless"> ';
        var leftHeight = 0;
        var leftWidth = 0;
        var rightHeight = 0;
        var rightWidth = 0;
