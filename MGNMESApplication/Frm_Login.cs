    ...
    public partial class Frm_Login : Form
    {
        ...
        private void cmdOK_Click(object sender, EventArgs e)
        {
            ...
            if (mg_user != null)
            {
                ...
                {
                    if (OPCConfig.WorkStation1 != mg_user.machineNO && OPCConfig.WorkStation2 != mg_user.machineNO)
                    {
        ...
        private void Frm_Login_Load(object sender, EventArgs e)
        {
            ...
            OPCConfig.Server = AppConfigHelper.GetAppConfig("Server");
            OPCConfig.WorkStation1 = AppConfigHelper.GetAppConfig("WorkStation1");
            OPCConfig.WorkStation2 = AppConfigHelper.GetAppConfig("WorkStation2");
